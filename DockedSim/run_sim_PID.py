...
ini_att = rot2quat(euler2rot(np.array([deg2rad(0.0), deg2rad(0.0), deg2rad(0.0)])))
...
pos_des = np.array([0.1, 0.0, 0.0])  # [x, y, z]
att_des = rot2quat(euler2rot(np.array([deg2rad(0.0), deg2rad(0.0), deg2rad(0.0)])))
